...
Full-stack interactive web application with:
- Interactive 3D globe with real-time city selection
- Crisis simulation engine modeling 30/60/90-day scenarios
- Vulnerability scoring system across 25+ major cities
- City comparison dashboard
- AI yield prediction page powered by TensorFlow.js neural networks
